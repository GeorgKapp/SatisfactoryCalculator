...
public class VirtualizedItemsControl : ItemsControl
{
    ...
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(VirtualizedItemsControl), new FrameworkPropertyMetadata(typeof(VirtualizedItemsControl)));
    }
    ...
    public static readonly DependencyProperty AutoResetVerticalScrollBarProperty = DependencyProperty.Register(nameof(AutoResetVerticalScrollBar), typeof(bool), typeof(VirtualizedItemsControl), new PropertyMetadata(true));
    ...
    public static readonly DependencyProperty AutoResetHorizontalScrollBarProperty = DependencyProperty.Register(nameof(AutoResetHorizontalScrollBar), typeof(bool), typeof(VirtualizedItemsControl), new PropertyMetadata(true));

    private void VirtualizedItemsControl_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        var scrollViewer = (ScrollViewer)GetTemplateChild("PART_ScrollViewer");
